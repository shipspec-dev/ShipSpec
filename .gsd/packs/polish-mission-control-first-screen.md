...
- Title: Polish Mission Control first screen
- Slug: polish-mission-control-first-screen
- Branch: codex/final-mission-control-polish

## Spec Files

- Proposal: openspec/changes/polish-mission-control-first-screen/proposal.md
- Tasks: openspec/changes/polish-mission-control-first-screen/tasks.md
...
- .gsd/reports/polish-mission-control-first-screen.md
