...
Active change: Add Agentic RAG skill router
...
- openspec/changes/add-agentic-rag-skill-router/proposal.md
- openspec/changes/add-agentic-rag-skill-router/tasks.md
- .gsd/reasoning/add-agentic-rag-skill-router.md
