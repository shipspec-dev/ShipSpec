# Add Agentic RAG skill router PR Report

## Summary

Prepared review report for `add-agentic-rag-skill-router`.

## Spec

openspec/changes/add-agentic-rag-skill-router

## Verification

- Evidence: .agent/evidence/add-agentic-rag-skill-router.md

## Auto Review

- Review: .gsd/reviews/add-agentic-rag-skill-router.md
